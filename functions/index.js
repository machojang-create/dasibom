...
const PT_AWARD = {   // 서버 권위 지급표(클라가 보낸 액수는 절대 안 믿음)
  ...
  /* ★FGT 100명에서 '보상 매력'이 전 항목 최저(62.9, 80대+ 44)로 나온 원인 수리 (2026-08-04).
     꽃잎이 게임류에만 붙어 있어서, 타깃이 가장 사랑하는 듣기·기르기·대화 계열은 보상이 0이었다.
     (타깃 선호 2위 온기 9명·3위 화분 6명·5위 라디오극장 5명·6위 챗봇 5명이 전부 미연결)
     화분·어항은 꽃잎을 '쓰기만 하고 벌지는 못하는' 구조여서 "모으는 속도가 느리다"는 지적도 여기서 나왔다. */
  ongi: 10,    // 추억의 소리, 온기 — 하루 1회
  yahwa: 10,   // 봄이의 라디오 극장 — 하루 1회
  plant: 10,   // 수다쟁이 화분 — 하루 1회
  guppy: 10,   // 우리집 구피 어항 — 하루 1회
  health: 10,  // 건강돋보기 — 하루 1회
  jobs: 10,    // 시니어 직업 상담소 — 하루 1회
  bomchat: 10  // 봄이와 대화 — 하루 1회
};
...
const PLANT_PRICES = {
  // 수다쟁이 화분
  normal_nut: 5, premium_nut: 10, seed: 100,   // 영양제 인하(2026-08-05 Macho: 15/40 -> 5/10)   // 생명(씨앗)은 비싸게 — Macho 밸런스 철학
  seed_season: 200,   // 제철 한정 씨앗(2026-08-05 Macho 하수구 1안) — 그 계절에만 판다
  ...
  guppy_decor_sand_castle: 60, guppy_decor_golden_statue: 350,   // 석상=효과템이라 장식 최고가 위로(2026-07-21) · 크기·가치 재조정(2026-08-05)
  // 장식 대확장(2026-07-21): 어항 꾸미기 하수구 심화
  guppy_decor_log: 30, guppy_decor_seaweed: 40, guppy_decor_shell_bed: 50,
  guppy_decor_treasure_chest: 80, guppy_decor_stone_tower: 120, guppy_decor_led_mood_light: 150,
  guppy_decor_neon_crystal: 180, guppy_decor_lighthouse: 250, guppy_decor_submarine: 300,
...
const UNLOCK_PRICES = {
  ...
  ongi: 100,
  /* 봄이 의상 1벌 = 500꽃잎(2026-08-05 Macho "비용을 좀 더 올려").
     봄이는 전 화면에 노출되는 유일한 캐릭터라 꾸미기 중 최상급 프리미엄. */
  bomfit: 500
};
